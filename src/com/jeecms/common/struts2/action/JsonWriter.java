...
public class JsonWriter {
	...
	private void serializeList(String records, String fields, String id,
			String total, long totalCount, @SuppressWarnings("rawtypes") List list) {
		if (total != null) {
	 ...
	 * Add array to buffer
	 */
	private void array(@SuppressWarnings("rawtypes") Iterator it, Method method) throws JSONException {
		this.add("[");
	 ...
	 * Ignore "class" field
	 */
	private boolean shouldExcludeProperty(@SuppressWarnings("rawtypes") Class clazz, PropertyDescriptor prop)
