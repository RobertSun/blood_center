...
public class ArtiIndeAct extends CmsIndeAction {
	...
	public String search() throws CorruptIndexException, IOException,
			ParseException {
		searchKey = RequestUtils.getQueryParam(ServletActionContext
				.getRequest(), "searchKey", "GBK");
		if (count > 200) {
			count = 200;
		}
		pagination = luceneArticleSvc.search(contextPvd
				.getAppRealPath(Constants.LUCENE_ARTICLE_PATH), searchKey,
				websiteId, chnlId, pageNo, count);
